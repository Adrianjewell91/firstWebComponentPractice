...
module.exports = { "default": __webpack_require__(/*! core-js/library/fn/reflect/construct */ "./node_modules/core-js/library/fn/reflect/construct.js"), __esModule: true };
...
/***/ "./scripts/airplaneGrid/airplaneGrid.js":
/*!**********************************************!*\
  !*** ./scripts/airplaneGrid/airplaneGrid.js ***!
  \**********************************************/
/*! no static exports found */
...
var AirplaneGrid = function (_CustomElement2) {
  ...
  function AirplaneGrid() {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (AirplaneGrid.__proto__ || (0, _getPrototypeOf2.default)(AirplaneGrid)).call(this));
  ...
  (0, _createClass3.default)(AirplaneGrid, [{
    ...
    value: function _buildPlane() {
      ...
      while (j < this._numberOfRows) {
        while (k < this._numberOfColumns) {
          var airplaneSeat = document.createElement('airplane-seat');
    ...
    key: '_alterTotalOccupied',
    value: function _alterTotalOccupied(e) {
      ...
      */
      ...
      if (e.target.shadowRoot.querySelector("#one-seat").classList.contains("occupied")) {
...
exports.default = AirplaneGrid;

/***/ }),

/***/ "./scripts/airplaneGrid/airplaneSeat.js":
/*!**********************************************!*\
  !*** ./scripts/airplaneGrid/airplaneSeat.js ***!
  \**********************************************/
/*! no static exports found */
...
*/
var AirplaneSeat = function (_CustomElement2) {
  (0, _inherits3.default)(AirplaneSeat, _CustomElement2);

  function AirplaneSeat() {
    (0, _classCallCheck3.default)(this, AirplaneSeat);

    var _this = (0, _possibleConstructorReturn3.default)(this, (AirplaneSeat.__proto__ || (0, _getPrototypeOf2.default)(AirplaneSeat)).call(this));

    var shadowRoot = _this.attachShadow({ mode: "open" });

    shadowRoot.innerHTML = "\n      <style>\n        :host {\n          /* margin-top: 5%; */\n          margin-bottom: 10px;\n        }\n\n        #one-seat {\n          border: 1px solid black;\n          width: 50px;\n          height: 50px;\n          display: inline-block;\n        }\n\n        .occupied {\n          background: green;\n        }\n      </style>\n      <div id=\"one-seat\"></div>\n    ";

    _this._seat = _this.shadowRoot.querySelector("#one-seat");
    _this._boundOnSeatClick = _this._changeColor.bind(_this);

    _this._seat.addEventListener("click", _this._boundOnSeatClick);
    return _this;
  }

  (0, _createClass3.default)(AirplaneSeat, [{
    key: "_changeColor",
...
exports.default = AirplaneSeat;

/***/ }),

/***/ "./scripts/airplaneGrid/index.js":
/*!***************************************!*\
  !*** ./scripts/airplaneGrid/index.js ***!
  \***************************************/
/*! no static exports found */
...
exports.OverHeadCompartment = exports.AirplaneGrid = exports.AirplaneSeat = undefined;

var _airplaneSeat = __webpack_require__(/*! ./airplaneSeat */ "./scripts/airplaneGrid/airplaneSeat.js");

var _airplaneSeat2 = _interopRequireDefault(_airplaneSeat);

var _airplaneGrid = __webpack_require__(/*! ./airplaneGrid */ "./scripts/airplaneGrid/airplaneGrid.js");

var _airplaneGrid2 = _interopRequireDefault(_airplaneGrid);

var _overHeadCompartment = __webpack_require__(/*! ./overHeadCompartment */ "./scripts/airplaneGrid/overHeadCompartment.js");

var _overHeadCompartment2 = _interopRequireDefault(_overHeadCompartment);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.AirplaneSeat = _airplaneSeat2.default;
exports.AirplaneGrid = _airplaneGrid2.default;
exports.OverHeadCompartment = _overHeadCompartment2.default;

/***/ }),

/***/ "./scripts/airplaneGrid/overHeadCompartment.js":
/*!*****************************************************!*\
  !*** ./scripts/airplaneGrid/overHeadCompartment.js ***!
  \*****************************************************/
/*! no static exports found */
...
var OverHeadCompartment = function (_CustomElement2) {
  ...
  function OverHeadCompartment() {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (OverHeadCompartment.__proto__ || (0, _getPrototypeOf2.default)(OverHeadCompartment)).call(this));
...
exports.default = OverHeadCompartment;
...
var _getWeatherElement = __webpack_require__(/*! ./getWeather/getWeatherElement */ "./scripts/getWeather/getWeatherElement.js");

var _getWeatherElement2 = _interopRequireDefault(_getWeatherElement);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            // 1:
            console.log(e);
            customElements.define('airport-weather', _getWeatherElement2.default);
            ...
            getAirportWeather = document.createElement('airport-weather');
...
/***/ "./scripts/getWeather/getWeatherElement.js":
/*!*************************************************!*\
  !*** ./scripts/getWeather/getWeatherElement.js ***!
  \*************************************************/
/*! no static exports found */
...
var GetAirportWeather = function (_CustomElement2) {
  (0, _inherits3.default)(GetAirportWeather, _CustomElement2);

  function GetAirportWeather() {
    (0, _classCallCheck3.default)(this, GetAirportWeather);

    /** Adds the shadow root */
    var _this = (0, _possibleConstructorReturn3.default)(this, (GetAirportWeather.__proto__ || (0, _getPrototypeOf2.default)(GetAirportWeather)).call(this));
  ...
  (0, _createClass3.default)(GetAirportWeather, [{
    key: "connectedCallback",
    value: function connectedCallback() {}
  }, {
    key: "getWeather",
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                a = fetch("https://api.openweathermap.org/data/2.5/weather?" + ("q=" + search + "&APPID=9e10e62732b3e1db6c5e879a13208af7"));
                b = void 0;
                _context.next = 4;
                return a.then(function (r) {
                  ...
                  var info = _this2.shadowRoot.getElementById('info');
                  if (info) {
                    info.remove();
                  }
                  ...
                  console.log(r);
                  _this2.shadowRoot.appendChild(info);
                });
